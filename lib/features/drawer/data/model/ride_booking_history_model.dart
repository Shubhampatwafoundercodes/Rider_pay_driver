class RideBookingHistoryModel {
  ...
  final int? code;
  final String? msg;
  final List<RideBookingHistoryModelDataSingle> data;

  factory RideBookingHistoryModel.fromJson(Map<String, dynamic> json){
    return RideBookingHistoryModel(
      code: json["code"],
      msg: json["msg"],
      data: json["data"] == null ? [] : List<RideBookingHistoryModelDataSingle>.from(json["data"]!.map((x) => RideBookingHistoryModelDataSingle.fromJson(x))),
    );
  }

}

class RideBookingHistoryModelDataSingle {
  RideBookingHistoryModelDataSingle({
  ...
  factory RideBookingHistoryModelDataSingle.fromJson(Map<String, dynamic> json){
    return RideBookingHistoryModelDataSingle(
      rideId: json["ride_id"],
