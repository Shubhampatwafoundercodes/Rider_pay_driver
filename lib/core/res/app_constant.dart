...
class AppConstant {
  ...
  static double get fontSizeLarge =>
      AppDevice.isMobile ? 20.sp : AppDevice.isTablet ? 23.sp : 25.sp;
  static double get fontSizeExtraLarge =>
      AppDevice.isMobile ? 24.sp : AppDevice.isTablet ? 26.sp : 28.sp;

  static double get fontSizeHeading =>
      AppDevice.isMobile ? 28.sp : AppDevice.isTablet ? 30.sp : 32.sp;
  static double get fontSizeLargeHeading =>
      AppDevice.isMobile ? 32.sp : AppDevice.isTablet ? 34.sp : 35.sp;
